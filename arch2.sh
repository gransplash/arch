...
if [[ $prog_set == 1 ]]; then
  ...
  sudo pacman -S chromium flameshot obs-studio vlc filezilla gimp libreoffice libreoffice-fresh-ru kdenlive neofetch qbittorrent galculator telegram-desktop --noconfirm
  yay -Syy
  yay -S xflux sublime-text-dev ttf-symbola ttf-clear-sans --noconfirm
